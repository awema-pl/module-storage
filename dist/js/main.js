(function () {
    ...
    var storageMixin = {
        ...
        beforeCreate() {
            this._config = Object.assign( _config, AWEMA.utils.object.get(AWEMA_CONFIG, 'storage', {}) );
        }
    };
    ...
    var __vue_render__ = function() {
      ...
      return _c("div", [
        _c("p", [
          ...
          _c("code", [_vm._v("STORAGE_EXAMPLE")]),
          _vm._v(" from "),
          _c("code", [_vm._v("storage/resources/lang/**/js.php")]),
          _vm._v(": " + _vm._s(_vm.$lang.STORAGE_EXAMPLE))
        ]),
        _vm._v(" "),
        _c(
          "button",
    ...
    __vue_render__._withStripped = true;
      ...
      var storage = normalizeComponent_1(
    ...
    var lang = {
        STORAGE_EXAMPLE: 'storage example',
    };
    ...
    const awemaPlugin = {
        ...
        install(AWEMA) {
            ...
            AWEMA._store.registerModule('storage', storageModule);
            AWEMA.lang = lang;
        }
    };
